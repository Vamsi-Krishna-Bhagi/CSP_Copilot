  ...
  <body>
    ...
    <form method="post" onsubmit="return subtractNumbers(event)">
      ...
      <input
        ...
        required
      /><br />
      <input type="submit" value="Subtract Numbers" style="background-color: red" />
    ...
    <form method="post" onsubmit="return multiplyNumbers(event)">
      ...
      <input
        ...
        required
      /><br />
      <input type="submit" value="Multiply Numbers" style="background-color: green" />
    </form>
    ...
    <form method="post" onsubmit="return divideNumbers(event)">
      ...
      <input
        ...
        required
      /><br />
      <input type="submit" value="Divide Numbers" style="background-color: yellow" />
    </form>

    <br /><br />
    <form method="post" onsubmit="return powerNumbers(event)">
      ...
      <input
        ...
        required
      /><br />
      <input type="submit" value="Power Numbers" style="background-color: orange" />
    </form>
